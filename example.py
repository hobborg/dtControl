...
from dtcontrol.decision_tree.determinization.prob_freq_determinizer import ProbFreqDeterminizer
from dtcontrol.decision_tree.impurity.entropy import Entropy
from dtcontrol.decision_tree.impurity.prob_entropy import ProbabilisticEntropy
...
classifiers = [
    ...
    DecisionTree(ProbFreqDeterminizer(), [aa], ProbabilisticEntropy(), 'ProbFreq2'),
]
