...
`SCOTS <https://www.hyconsys.com/software/scots/>`_ [1]_ and `Uppaal Stratego <https://people.cs.aau.dk/~marius/stratego/>`_. Additionally, there is rudimentary support for strategies produced by `PRISM Model Checker <https://www.prismmodelchecker.org>`_ and a pipeline with the model checker `Storm <http://www.stormchecker.org/index.html>`_ is under works.
...
..[1] See these `notes <https://gitlab.com/live-lab/software/dtcontrol-examples/-/blob/master/cps/ReadMe.md>`_ on the SCOTS support.
