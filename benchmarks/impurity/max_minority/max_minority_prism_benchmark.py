...
classifiers = [
    ...
    DecisionTree(LabelPowersetDeterminizer(), [aa, categorical], MaxMinority(), 'Cat-max'),
    DecisionTree(LabelPowersetDeterminizer(), [aa, grouping], Entropy(), 'Group-ent'),
    DecisionTree(LabelPowersetDeterminizer(), [aa, grouping], MaxMinority(), 'Group-max'),
    DecisionTree(LabelPowersetDeterminizer(), [aa, single], Entropy(), 'Single-ent'),
    DecisionTree(LabelPowersetDeterminizer(), [aa, single], MaxMinority(), 'Single-max'),
    DecisionTree(LabelPowersetDeterminizer(), [aa, single, categorical], Entropy(), 'Both-ent'),
    DecisionTree(LabelPowersetDeterminizer(), [aa, single, categorical], MaxMinority(), 'Both-max'),
]
