...
foo1 = sp.sympify("x_0*10 + x_1*11 + x_3*12 + x_10*14 + c_0")
foo1 = foo1.subs([(c_0, 10000)])

args = sorted(foo1.free_symbols, key=lambda x: int(str(x).split("_")[1]))
f = sp.lambdify(args, foo1)
arrr = np.array([0, 0, 1, 0])
