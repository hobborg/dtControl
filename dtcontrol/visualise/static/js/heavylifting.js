...
function postload() {
    ...
    //           //if that preset cntains that property
...
$(document).ready(function() {
    ...
    $("#config").change(function() {
                ...
                for (y in defConf) {
                    ...
                    if (y in data2.presets[x]) {
                        if (y == "tolerance") {
                            ...
                            // $("#"+data2.presets[x][y]).attr('selected',true);
                            $("#" + y).val(data2.presets[x][y]);
                            // console.log("changed value of");
                            // console.log(y);
                            // console.log("to");
        ...
        // }catch(e){
        //     console.log('Presets not discovered yet');
        // }
