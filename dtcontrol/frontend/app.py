...
@app.route("/computed")
def computed():
    global selected_computation_id, saved_tree, minBounds, maxBounds, stepSize, numVars, numResults
    # json_tree, saved_tree, minBounds, maxBounds, stepSize, numVars, numResults, controller_name = completed_experiements[selected_computation_id]
