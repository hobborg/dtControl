...
/************************************************************************/
classify (points, no_of_points, root, output) POINT** points;
int no_of_points;
char* output;
...
/*				main (gendata.c)			*/
/************************************************************************/
print_point (out, cur_point, unlabeled) FILE* out;
POINT* cur_point;
int unlabeled;
{
    int i;
...
/************************************************************************/
struct test_outcome estimate_accuracy (points, no_of_points, root) POINT** points;
int no_of_points;
struct tree_node* root;
{
    FILE *infile, *outfile;
    ...
    if (root == NULL) error ("Esimate_Accuracy : Called with empty decision tree.");
